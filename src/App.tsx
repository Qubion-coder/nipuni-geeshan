...
function FloatingPetals({ disabled = false }: { disabled?: boolean }) {
  ...
  useEffect(() => {
    ...
    const colors = ["#fee1cc", "#ffc399", "#ffa565", "#fff0e5"];
  ...
  return (
    <div className={`pointer-events-none fixed inset-0 overflow-hidden z-40 ${isLowPowerMode ? "opacity-70" : ""}`}>
      {petals.map((petal) => (
        <motion.div
          key={petal.id}
          className="absolute drop-shadow-[0_2px_6px_rgba(204,85,0,0.5)]"
...
function CountdownTimer() {
  const targetDate = new Date("November 27, 2026 17:48:00").getTime();
        ...
        {!isOpened ? (
          ...
          >
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-10">
              ...
              <p className="text-stone-500 text-sm tracking-[0.2em] font-light">NOVEMBER 27, 2026</p>
            </motion.div>
            ...
            >
              <div className="absolute -inset-8 bg-[radial-gradient(circle,_rgba(204,85,0,0.35)_0%,_rgba(254,225,204,0.2)_45%,_transparent_75%)] blur-3xl opacity-90" />
              <div className="absolute inset-0 bg-gradient-to-b from-[#fffefb] via-[#fff9f2] to-[#fff6ee] rounded-[1.4rem] shadow-[0_28px_80px_-20px_rgba(81,33,0,0.35)] border border-theme-200/80 overflow-hidden" />
              ...
              {/* Left Flap */}
              <motion.div
                className="absolute inset-y-0 left-0 w-1/2 bg-gradient-to-br from-theme-700 via-theme-600 to-theme-800 z-30 shadow-[8px_0_28px_rgba(30,15,10,0.45)] origin-left flex items-center justify-end pr-4 overflow-hidden rounded-l-[1.2rem]"
              ...
              {/* Right Flap */}
              <motion.div
                className="absolute inset-y-0 right-0 w-1/2 bg-gradient-to-bl from-theme-700 via-theme-600 to-theme-800 z-30 shadow-[-8px_0_28px_rgba(30,15,10,0.45)] origin-right flex items-center justify-start pl-4 overflow-hidden rounded-r-[1.2rem]"
                whileHover={{ rotateY: 14 }}
                transition={{ type: "spring", stiffness: 110, damping: 16 }}
              >
                <div className="absolute inset-0 opacity-20 paper-grain" />
              ...
              <motion.div
                ...
                whileTap={{ scale: 0.9 }}
                className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-40 w-28 h-28 rounded-full bg-gradient-to-br from-theme-200 via-[#fff8f5] to-theme-300 shadow-[0_20px_45px_-10px_rgba(122,50,0,0.65)] border-[5px] border-[#523325] flex items-center justify-center group-hover:shadow-theme-500/40"
              >
                ...
                <div className="text-center relative z-10">
                  <p className="font-cinzel text-[1.7rem] font-bold text-stone-800 leading-none">N&G</p>
          ...
          >
                ...
                <div className="flex flex-col items-center text-center space-y-4 flex-1 w-full relative z-10">
                  ...
                  >
                    ...
                    <div className="font-cinzel space-y-1">
                      <p className="text-sm md:text-base text-stone-700 tracking-[0.2em] md:tracking-[0.3em] font-bold">27 NOVEMBER 2026</p>
                      <p className="text-[8px] md:text-[9px] text-theme-600 tracking-[0.2em] uppercase font-bold">Homagama, Sri Lanka</p>
                    </div>
                  </motion.div>
                </div>
              </motion.div>
            ...
            <section className="cv-auto py-24 md:py-32 w-full flex flex-col items-center px-4 relative">
              ...
              <div className="max-w-[1000px] w-full flex flex-col items-center text-center relative z-10">
                ...
                >
                  ...
                  <div className="relative bg-white/90 p-2.5 md:p-3 rounded-[2rem] border border-theme-200 shadow-[0_20px_50px_-20px_rgba(122,50,0,0.45)]">
                    <InviteImage
                      src={brideGroomImage}
                  ...
                  >
                    ...
                    <div className="relative z-10 space-y-4 py-8 md:py-12">
                      <div className="space-y-2">
                        ...
                        <p className="text-xs md:text-sm font-cinzel text-stone-600 tracking-wide leading-relaxed">Mr. Nimalsiri Thissera<br />& Mrs. Walpita Gamage Shanthi</p>
                      </div>
                  ...
                  >
                    ...
                    <div className="relative z-10 space-y-4 py-8 md:py-12">
                      <div className="space-y-2">
                        ...
                        <p className="text-xs md:text-sm font-cinzel text-stone-600 tracking-wide leading-relaxed">Mr. Premawansha Herath<br />& Mrs. Seela Herath</p>
                      </div>
                      <h3 className="text-5xl md:text-7xl font-playball text-theme-800 group-hover:scale-110 transition-transform duration-700 pt-6 drop-shadow-sm">Geeshan</h3>
                    </div>
                  </motion.div>
                </div>
                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-32 text-center w-full max-w-4xl px-4">
                    <div className="flex flex-col items-center flex-1">
                      ...
                      <p className="font-cinzel text-xl md:text-3xl text-theme-900 tracking-widest font-bold whitespace-nowrap">FRIDAY, 27 NOV</p>
                    ...
                    <div className="flex flex-col items-center flex-1">
                      ...
                      <p className="font-cinzel text-xl md:text-3xl text-theme-900 tracking-widest font-bold whitespace-nowrap">06:30 PM</p>
                  ...
                  <div className="pt-8 w-full px-4">
                    <div className="relative inline-flex items-center justify-center w-full max-w-md mx-auto group">
                      ...
                      <p className="relative text-theme-800 bg-white shadow-[0_4px_20px_-5px_rgba(0,0,0,0.05)] text-[9px] md:text-[11px] font-bold tracking-[0.3em] md:tracking-[0.4em] uppercase px-6 lg:px-10 py-4 lg:py-5 rounded-full border border-theme-200 flex items-center justify-center gap-4 w-full md:w-auto">
                        ...
                        <span className="whitespace-nowrap">Poruwa Ceremony at 05:48 PM</span>
                        <span className="w-1.5 h-1.5 rotate-45 bg-theme-500 shrink-0" />
                      </p>
                    </div>
                  </div>
                ...
                <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
                  ...
                  >
                    ...
                    <div className="space-y-6 pt-4 relative">
                      ...
                      <div className="pl-8 space-y-4">
                        ...
                        <p className="text-lg md:text-xl text-stone-700 font-cinzel font-medium leading-relaxed tracking-wide">
                          No 06, Pinketha Road,<br /> Homagama.
                        </p>
                      </div>
                    ...
                    <div className="pt-8 w-full md:w-auto">
                      <button
                        onClick={() => window.open('https://maps.app.goo.gl/S4ExfmK79q5CjUWQ6', '_blank')}
            ...
            {/* RSVP Section */}
            <section className="cv-auto py-24 md:py-36 bg-[#CC5500] text-white relative overflow-hidden flex flex-col items-center">
              ...
              <div className="container mx-auto px-4 max-w-2xl text-center relative z-10 w-full">
                ...
                >
                  ...
                  <p className="text-stone-300 text-sm md:text-base max-w-md mx-auto leading-relaxed mb-16 tracking-wide font-light">
                    As we need to finalize the details for the celebration, your early response is incredibly helpful to us and our vendors. Please let us know your plans before 20th of November 2026!
                  </p>
                ...
                <div className="container mx-auto px-4 max-w-4xl text-center relative z-10 w-full">
                  ...
                  >
                    ...
                    <div className="mt-32 md:mt-48 space-y-6 flex flex-col items-center relative w-full">
                      ...
                      <h3 className="font-playball text-[3.2rem] sm:text-6xl md:text-8xl text-theme-900 relative z-10 drop-shadow-sm px-4 pt-4 leading-none">Nipuni & Geeshan</h3>
                      ...
                      <motion.img
                        ...
                        src="/images/mandala_test.png"
                        alt=""
                        className="relative z-10 mt-8 w-40 h-40 md:w-56 md:h-56 object-contain mix-blend-multiply drop-shadow-[0_12px_24px_rgba(204,85,0,0.2)]"
                      />
                    </div>
                  </motion.div>
                </div>
